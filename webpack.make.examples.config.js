...
//var appModuleRoot = path.join(__dirname, './app/scripts/vendor/legacy');
...
module.exports = function(options) {
    ...
    var entry = {
        ...
        ,css:'./examples/styles/themes/paper/all.scss'
        //,common:[
        //    "react"
        //    ,"react-router"
        //    ,"underscore"
    ...
    var output = {
        path: path.join(__dirname, "./examples/extras/", options.prerender ? "build" : "release")
